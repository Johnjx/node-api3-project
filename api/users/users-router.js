...
const { validateUserId, validateUser, validatePost, validateUserPost } = require('../middleware/middleware')
...
router.post('/:id/posts', validateUserId, validateUserPost, (req, res, next) => {
